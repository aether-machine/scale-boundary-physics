...
```
A single displacement at the first site should interact with
both neighboring sites through the periodic lattice.
"""
...
because both the linear and cubic restoring terms are odd.
"""
